...
<template>
  <div class="navbar-container">
      ...
      <div class="container">
        <div class="col-12 d-flex align-items-center">
          ...
          <div class="d-flex align-items-center me-auto py-1">
            <router-link :to="'/'">
              <img src="../assets/images/Drink-X Logo.png" style="width: auto; height: 30px" />
            </router-link>
                          ...
                          <div class="col-10 col-sm-11">
                            <div class="notification-logo">
                              <img v-if="notification.logo" :src="notification.logo" alt="Venue logo"
                                class="logo-image">
                              <img v-else src="../assets/images/Drinks/Placeholder.png" alt="Default logo"
                                class="logo-image">
                            </div>
    ...
    <div class="col-12 primary-square mt-2 py-1">
      <div class="mobile-view-show col-12 ps-4 pe-4 d-flex justify-content-center py-2">
        ...
        <!-- <div class="search-bar d-flex align-items-center col-12 position-relative">
          ...
          <img src="../assets/images/Others/search-green.png" style="
              width: 25px;
              height: 25px;
              margin: 0px 10px;
              align-self: center;
    ...
    // import { useSearch } from '@/composables/navbar/useSearch'; // Auto-imported by Nuxt
