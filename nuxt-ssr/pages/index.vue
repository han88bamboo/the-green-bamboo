<!--
Key changes:
1.  Uses <script setup> for Composition API, which is the standard in Nuxt 3+.
2.  Data fetching is moved from the client-side `mounted` hook to Nuxt's `useFetch` composable. This allows data to be fetched on the server, improving SEO and initial page load performance.
3.  All <router-link> components are replaced with <NuxtLink>.
4.  The `useSearch` composable is now imported from `~/composables/useSearch`.
5.  Component imports use the `~/` alias, which points to the project root.
6.  Environment variables are accessed via `useRuntimeConfig()`.
-->
<template>
    <main>
        <!-- Hero Section with Search -->
        <section class="hero-section text-center">
            <img src="https://cdn.shopify.com/s/files/1/0353/9510/9003/files/another-round-mads-mikkelsen.webp?v=1758423054"
                class="hero-bg" style="filter: brightness(0.5);"
                ...
                <div class="row justify-content-center w-100">
                    <div class="col-12 col-md-8 col-lg-6">
                        ...
                        <div class="col-12 align-items-center justify-content-center mb-4">
                            <NuxtLink :to="'/explore'">
                                <button class="btn btn-md text-white fw-bold mobile-rating-smaller-text-2"
                                    style="background-color: #83a9e8; margin-top: 1rem;" aria-label="Surprise Me!">
                                    Surprise Me!
                                </button>
                            </NuxtLink>
                        </div>
            ...
            <div class="container">
                ...
                <div class=" rounded-4 p-4 mb-2 position-relative overflow-hidden">
                    <div
                        ...
                        <div>
                            <div
                                class="d-flex flex-column flex-md-row align-items-center align-items-md-end gap-3 mb-2">
                                <!-- Logo -->
                                <img src="https://cdn.shopify.com/s/files/1/0353/9510/9003/files/wlp25-logo-en.svg?v=1758788335"
                                    alt="Whisky Live Paris 2025 Logo" class="festival-logo" />
                                <span
                                    class="festival-badge-new d-inline-flex align-items-center px-3 py-1 me-2 rounded-pill">
                                    NEWLY RELEASED
                                </span>
                            </div>
                            <h2 class="mobile-fs-4 fw-bold mb-1 festival-title">Now Pouring at Whisky Live Paris 2025
                            </h2>
                            <h3 class="mobile-fs-6 fw-bold h5 m-0 festival-subtitle">Explore and review drinks at this
                                event!</h3>
                        </div>
                        <!-- Countdown pill -->
                        <div class="festival-countdown ms-md-3 mt-md-0 px-3 py-2 rounded-pill 
                    ...
                    <div class="trending-reviews-grid">
                        <div v-for="listing in wlp2025Listings" :key="listing.listingId" class="trending-review-col">
                            <div class="card h-100 review-card border-light"
                                style="border: 2px solid #f0b358; cursor: pointer;" @click="goToListing(listing)">
                                <!-- Image at top -->
                                <div class="card-img-top-wrapper position-relative">
                                    <img v-if="listing.photo" :src="listing.photo" class="card-img-top review-card-img"
                                        :alt="listing.listingName" />
                                    <img v-else
                                        src="https://cdn.shopify.com/s/files/1/0353/9510/9003/files/defaultDrinkImage.png?v=1750084739"
                                        class="card-img-top review-card-img" alt="Default drink image" />
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="mb-2 small" style="color: #f0b358;"
                                        v-if="listing.drinkType || listing.originCountry">
                                ...
                                <div class="text-center pb-3">
                                    <button class="btn fw-semibold px-4" @click="goToListing(listing)"
                ...
                <div class="festival-sticky-cta ">
                    <button class="btn w-100 festival-btn-cta fw-semibold"
                        @click="$router.push('/find-lists?listId=330&name=whisky-live-paris-2025-watchlist')">
                ...
                <div class="trending-reviews-container">
                    <div class="trending-reviews-grid">
                        <div v-for="review in recentReviews" :key="review.reviewId" class="trending-review-col">
                            <div class="card h-100 review-card border-light"
                                style="border: 2px solid #f0b358; cursor: pointer;" @click="goToListing(review)">
                                <!-- Image at top with overlay -->
                                <div class="card-img-top-wrapper position-relative">
                                    <img v-if="review.photo" :src="review.photo" class="card-img-top review-card-img"
                                        :alt="review.listingName" />
                                    <img v-else-if="review.listingPhoto" :src="review.listingPhoto"
                                        class="card-img-top review-card-img" :alt="review.listingName" />
                                    <img v-else
                                        src="https://cdn.shopify.com/s/files/1/0353/9510/9003/files/defaultDrinkImage.png?v=1750084739"
                                        class="card-img-top review-card-img" alt="Default drink image" />
                                    ...
                                    <div class="review-overlay position-absolute d-flex align-items-center">
                                        <img v-if="review.userPhoto" :src="review.userPhoto" class="rounded-circle me-1"
                                        ...
                                        <span class="overlay-text">
                                            ...
                                            <span class="overlay-rating">{{ parseFloat(review.rating) &&
                                                !isNaN(parseFloat(review.rating)) ? parseFloat(review.rating).toFixed(1)
                                                : 'N/A' }}★</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <!-- Category and Country -->
                                    <p class="mb-2 small" style="color: #f0b358;"
                                        v-if="review.drinkType || review.originCountry">
                                ...
                                <div class="text-center pb-3">
                                    <button class="btn fw-semibold px-4" @click="goToListing(review)"
                                        style="background-color: #f04444; border-color: #f04444; color: white;">
                                        Read Review
                                    </button>
                                </div>
                ...
                <div class="venue-reviews-container">
                    <div class="venue-reviews-grid">
                        <div v-for="review in venueReviews" :key="review.reviewId" class="venue-review-col">
                            <div class="card h-100 review-card border-light"
                                style="border: 2px solid #3CB371; cursor: pointer;" @click="goToVenue(review)">

                                <!-- Venue Info Header - Horizontal layout with venue photo and name -->
                                <div class="venue-header p-3 d-flex align-items-center"
                                    style="background-color: #f8f9fa; width:100%; min-width:250px;">
                                    <!-- Venue Profile Photo -->
                                    <img v-if="review.venuePhoto" :src="review.venuePhoto"
                                ...
                                <div class="venue-photos-container position-relative"
                                    ...
                                    <div class="d-flex w-100" style="height: 200px;">
                                        ...
                                        <div v-if="review.photos.length === 1" class="photo-container w-100">
                                            <img :src="review.photos[0]" class="w-100 h-100" style="object-fit: cover;"
                                                :alt="'Review photo 1'" />
                                        </div>
                                        ...
                                        <template v-else-if="review.photos.length === 2">
                                            <div class="photo-container" style="width: 50%; margin-right: 2px;">
                                                <img :src="review.photos[0]" class="w-100 h-100"
                                                    style="object-fit: cover;" :alt="'Review photo 1'" />
                                            </div>
                                            <div class="photo-container" style="width: 50%; margin-left: 2px;">
                                                <img :src="review.photos[1]" class="w-100 h-100"
                                                    style="object-fit: cover;" :alt="'Review photo 2'" />
                                            </div>
                                        </template>
                                        ...
                                        <template v-else-if="review.photos.length >= 3">
                                            ...
                                            <div class="d-flex flex-column h-100" style="width: 40%; margin-left: 2px;">
                                                ...
                                                <div class="photo-container"
                                                    style="height: calc(50% - 2px); margin-bottom: 2px;">
                                                    <img :src="review.photos[1]" class="w-100 h-100"
                                                        style="object-fit: cover;" :alt="'Review photo 2'" />
                                                </div>
                                                <!-- Third photo -->
                                                <div class="photo-container"
                                                    style="height: calc(50% - 2px); margin-top: 2px;">
                                                    <img :src="review.photos[2]" class="w-100 h-100"
                                                        style="object-fit: cover;" :alt="'Review photo 3'" />
                                                </div>
                                            </div>
                                        </template>
                                    </div>
                                    ...
                                    <div class="review-overlay position-absolute d-flex align-items-center">
                                        ...
                                        <span class="overlay-text">
                                            ...
                                            <span class="overlay-rating">{{ parseFloat(review.rating) &&
                                                ...
                                                parseFloat(review.rating).toFixed(1) : 'N/A' }}★</span>
                                        </span>
                                    </div>
                                </div>

                                <!-- Default image if no photos -->
                                <div v-else class="default-venue-image position-relative"
                                ...
                                <!-- Read Review Button Footer -->
                                <div class="text-center pb-3">
                                    <button class="btn fw-semibold px-4" @click="goToVenue(review)"
                    ...
                    <button class="btn fw-semibold px-4 mt-3" @click="$router.push({ name: 'browseVenue' })"
                        style="background-color: #f04444; border-color: #f04444; color: white;">
                        Find Venue 🗺️ 🔎
                    </button>
                </div>
                            ...
                            <div class="menu-card h-100" v-if="venueMenus[0]">
                                <div class="menu-card-header p-3 text-center">
                                    ...
                                    <div class="d-flex justify-content-center mb-2">
                                        <img :src="venueMenus[0].venuePhoto" :alt="venueMenus[0].venueName"
                                            class="rounded-circle"
                                            style="width: 60px; height: 60px; object-fit: cover; border: 2px solid #fff; cursor: pointer;"
                                            @click="goToVenue(venueMenus[0])" />
                                    </div>
                                    <h5 class="mb-1 fw-bold mobile-fs-6" @click="goToVenue(venueMenus[0])"
                                ...
                                <div class="menu-items-list p-3 pb-0">
                                    <div v-for="item in venueMenus[0].menuItems"
                                        ...
                                        <div class="menu-item-image me-3">
                                            <img :src="item.listingPhoto" :alt="item.listingName" class="rounded"
                                        ...
                                        <div class="menu-item-details flex-grow-1 text-start">
                                            ...
                                            <div class="d-flex justify-content-between align-items-start mt-1">
                                                <div class="d-flex flex-wrap gap-1">
                                                    ...
                                                    <span v-if="item.typeCategory" class="badge bg-info"
                                                        style="font-size: 0.7rem;">
                                                        {{ item.typeCategory }}
                                                    </span>
                                                </div>
                                                <div v-if="item.avgRating && item.avgRating > 0"
                                                    class="rating-display text-end">
                                                    <span class="rating-text"
                                                        style="color: #f0b358; font-weight: bold; font-size: 0.8rem;">
                                ...
                                <div class="menu-card-footer  text-center pb-3">
                                    <button class="btn btn-warning fw-semibold px-4" @click="goToVenue(venueMenus[0])"
                        ...
                        <div class="col-4 ">
                            <div class="menu-card h-100" v-if="venueMenus[1]">
                                <div class="menu-card-header p-3 text-center">
                                    <!-- Venue Profile Photo -->
                                    <div class="d-flex justify-content-center mb-2">
                                        <img :src="venueMenus[1].venuePhoto" :alt="venueMenus[1].venueName"
                                            class="rounded-circle"
                                            style="width: 60px; height: 60px; object-fit: cover; border: 2px solid #fff; cursor: pointer;"
                                            @click="goToVenue(venueMenus[1])" />
                                    </div>
                                    <h5 class="mb-1 fw-bold mobile-fs-6" @click="goToVenue(venueMenus[1])"
                                        @mouseover="$event.target.style.color = '#E9ECEF'"
                                        @mouseout="$event.target.style.color = '#ffffff'">
                                ...
                                <div class="menu-items-list p-3 pb-0">
                                    <div v-for="item in venueMenus[1].menuItems"
                                ...
                                <div class="menu-card-footer  text-center pb-3">
                                    <button class="btn btn-warning fw-semibold px-4" @click="goToVenue(venueMenus[1])"
                                        style="background-color: #EBA446; border-color: #EBA446; color: black;">
                                        View Menu
                                    </button>
                                </div>
                        ...
                        <div class="col-4">
                            <div class="menu-card h-100" v-if="venueMenus[2]">
                                <div class="menu-card-header p-3 text-center">
                                    <!-- Venue Profile Photo -->
                                    <div class="d-flex justify-content-center mb-2">
                                        <img :src="venueMenus[2].venuePhoto" :alt="venueMenus[2].venueName"
                                            class="rounded-circle"
                                            style="width: 60px; height: 60px; object-fit: cover; border: 2px solid #fff; cursor: pointer;"
                                            @click="goToVenue(venueMenus[2])" />
                                    </div>
                                    <h5 class="mb-1 fw-bold mobile-fs-6" @click="goToVenue(venueMenus[2])"
                                        @mouseover="$event.target.style.color = '#E9ECEF'"
                                        @mouseout="$event.target.style.color = '#ffffff'">
                                ...
                                <div class="menu-items-list p-3 pb-0">
                                    <div v-for="item in venueMenus[2].menuItems"
                                ...
                                <div class="menu-card-footer text-center pb-3">
                                    <button class="btn btn-warning fw-semibold px-4" @click="goToVenue(venueMenus[2])"
                                        style="background-color: #EBA446; border-color: #EBA446; color: black;">
                                        View Menu
                                    </button>
                                </div>
        ...
        <!-- Editorial Section -->
        <editorialSection :loading="loading" :articles="articles" :sectionTitles="sectionTitles" />
        <!-- Editorial End -->
...
// (optional) explicit imports if not using auto-components
...
import BusinessSection from '~/components/landing_page/BusinessSection.vue';
    ...
    methods: {
        ...
        async loadData(url) {
            ...
            try {
                ...
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/getData/getUser/${this.userID}`)
        ...
        async fetchTop8() {
            try {
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/getData/getTop8`)
        ...
        async fetchTopListings() {
            try {
                // ✅ get runtime config
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/getData/getTopListings`)
        ...
        async fetchRSS() {
            ...
            try {
                // ✅ get runtime config
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/rssFeed/rssfeed`)
        ...
        async fetchRSSReviews() {
            ...
            try {
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/rssFeed/rssfeedreviews`)
        ...
        async fetchRecentReviews() {
            try {
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/getData/get5MostRecentReviews`)
        ...
        async fetchTopRatedReviews() {
            try {
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/getData/get5MostHighlyRatedReviews`)
        ...
        async fetchVenueReviews() {
            try {
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/getData/getMostRecentVenueReviews`);
        ...
        async fetchWlp2025Listings() {
            try {
                const config = useRuntimeConfig()
                const response = await $fetch(`${config.public.apiUrl}/getData/getListingsWlp2025`);
        ...
        async fetchVenueMenus() {
            ...
            try {
                ...
                $fetch(`${config.public.apiUrl}/getData/getWhatsOnMenu/${venueId}`)
                    .catch(error => {
