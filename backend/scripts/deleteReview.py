...
def deleteReview(id):
    with db_manager.get_cursor(commit=False) as cursor:
        ...
        cursor.execute('SELECT SUM("proofPoints") FROM "pointSystemRules" WHERE id IN %s', (tuple(rule_points_id),))
        ...
        try:
            ...
            cursor.execute("DELETE FROM \"reviewsUserVotes\" WHERE \"reviewId\" = %s", (id,))
