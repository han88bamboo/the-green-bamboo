                ...
                if existing_amenities:
                    ...
                    cur.execute(
                        ...
                        ("venueId", "paymentCash", "paymentVisa", "paymentMasterCard", "paymentAmericanExpress", "paymentDiscover",
                         "paymentApplePay", "paymentGooglePay", "paymentPayNow", "paymentSamsungPay", "beverageCocktails",
                         "beverageWine", "beverageBeer", "beverageWhisky", "beverageBrandy", "beverageTequila", "beverageRum",
                         "beverageGin", "beverageVodka", "beverageSake", "foodServed", "outdoorSeating", "indoorSeating",
                         "petFriendly", "childFriendly", "familyFriendly", "smokeFriendly", "wheelchairAccessibility",
                         "freeWiFi", "liveMusic", "barGames", "happyHourDrinks", "deliveryAvailable", "lgbtqFriendly",
                         "reservationsRequired", "membershipRequired", "sommelierService", "inStoreScheduling", "otherAmenities")
