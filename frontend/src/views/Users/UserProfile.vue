            ...
            <div class="row">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-start pe-0">
                                ...
                                <img :src="selectedImage || (displayUser.photo || defaultProfilePhoto)" alt=""
                            ...
                            <div class="col-8">
                                ...
                                <button v-if="displayUser && displayUser.modType && (displayUser.modType.length > 0)"
                                    data-bs-toggle="modal" data-bs-target="#moderatormodal"
                        ...
                        <!-- buttons -->
                        <div class="row mt-3">
                            <button v-if="ownProfile && user" type="button"
                                class="btn tertiary-btn-blue-outline xprimary-btn-outline-not-round"
                                data-bs-toggle="modal" data-bs-target="#editProfileModal" style="font-weight:bold;">Edit
                                Profile</button>
                            <button v-else-if="following && user" type="button"
                                class="btn primary-btn-outline-less-round"
                                @click="editFollow('unfollow')">Following</button>
                            <button v-else-if="user" type="button" class="btn primary-btn-less-round-blue"
                                @click="editFollow('follow')" style="font-weight:bold;">+ Follow User</button>
                            <router-link v-if="ownProfile && user" :to="{ path: '/dashboard/user' }"
                            ...
                            <span style="position: relative; display: inline-block" class="m-0 p-0">
                                <div v-if="!ownProfile && displayUser.modType != []" class="speech-bubble">{{
                                    displayUser.modType ? displayUser.modType.join(', ') : 'None' }}</div>
                                <button v-if="user && user.isAdmin"
                                    class="btn tertiary-btn-blue reverse-clickable-text mt-3" style="width: 100%"
                                    type="button" data-bs-toggle="modal" data-bs-target="#addModeratorModal">Add/Remove
                                    Moderator Rights</button>
                            </span>


                            <button v-if="ownProfile && user" type="button" class="btn secondary-btn-less-round mt-3"
                                data-bs-toggle="modal" data-bs-target="#changePasswordModal">Change/Reset
                                Password</button>
                        </div>

                        <!-- join as a moderator modal start -->
                        <div class="modal fade" id="moderatormodal" tabindex="-1" aria-labelledby="moderatorModalLabel"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div v-if="drinkChoice.length == 0" class="modal-body px-4">
                                        <div class="d-flex justify-content-between ">
                                            <button v-if="displayUser.modType && displayUser.modType.length != 0"
                                                data-bs-toggle="modal" data-bs-target="#moderatormodal"
                                                class="btn btn-warning hover-button p-1 mb-3"
                                                style="border-radius: 20px; font-size: 0.8rem;">★ Certified
                                                Moderator</button>
                                            ...
                                            <button type="button" class="btn-close uninvert" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <p><b>{{ displayUser.displayName }} is a Drink-X moderator.</b></p>
                                        <p><b><em>Moderators help shape the drinks community and ensure drink reviews
                                                    remain fun, useful and respectful!</em></b></p>
                                        <b><a v-if="user && !user.isAdmin" href="#" class="mt-3" data-bs-toggle="modal"
                                                data-bs-target="#applyModerator" style="color: black">Want to be a
                                                moderator? Apply here!</a></b>
                                    </div>
                                    ...
                                    <div style="display: flex; justify-content: flex-end;">
                                        ...
                                        <p><b>{{ displayUser.displayName }} is a moderator of the following
                                                communities:</b></p>
                        ...
                        <!-- Mod addition modal -->
                        <div class="modal fade" id="addModeratorModal" data-bs-backdrop="static" tabindex="-1"
                            aria-labelledby="addModeratorLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div v-if="chooseMod == 'add' && !doubleConfirmMod && !(successAddMod || errorAddMod || successRemoveMod || errorRemoveMod)"
                                        class="modal-body">
                                        <div class="form-group mb-3">
                                            <p class="text-start mb-1"> Choose drink type that user can moderate: <span
                                                    class="text-danger">*</span></p>
                                            <p v-html="formattedModTypes" class="text-start mb-1"></p>
                                            <input list="addableDrinkType" v-model="promotedType" class="form-control"
                                                id="promotedType" placeholder="Enter drink type"
                                                v-on:change="updateDrinkType">
                                            <datalist id="addableDrinkType">
                                                <option v-for="drinkType in addableDrinkType" :key="drinkType.id"
                                                    :value="drinkType.drinkType">
                                                    {{ drinkType.drinkType }}
                                                </option>
                                            </datalist>
                                            <p v-show="promotedType.length > 0" class="text-start mb-1 text-danger"
                                                id="promotedTypeError"></p>
                                        </div>
                                        <p class="text-start mb-1 text-danger" id="alreadyModError"></p>
                                    </div>

                                    <div v-if="chooseMod == 'remove' && !doubleConfirmMod && !(successAddMod || errorAddMod || successRemoveMod || errorRemoveMod)"
                                        class="modal-body">
                                        <div class="form-group mb-3">
                                            <p class="text-start mb-1"> Choose drink type for user to remove moderator
                                                rights: <span class="text-danger">*</span></p>
                                            <p v-html="formattedModTypes" class="text-start mb-1"></p>
                                            <input list="removableDrinkType" v-model="removedType" class="form-control"
                                                id="removedType" placeholder="Enter drink type"
                                                v-on:change="updateRemovedDrinkType">
                                            <datalist id="removableDrinkType">
                                                <option v-for="drinkType in removableDrinkType" :key="drinkType.id"
                                                    :value="drinkType.drinkType">
                                                    {{ drinkType.drinkType }}
                                                </option>
                                            </datalist>
                                            <p v-show="promotedType.length > 0" class="text-start mb-1 text-danger"
                                                id="removedTypeError"></p>
                                        </div>
                                    ...
                                    <div v-if="chooseMod == 'add' && doubleConfirmMod && !(successAddMod || errorAddMod || successRemoveMod || errorRemoveMod)"
                                        class="modal-body">
                                        <p class="text-start mb-1"> Do you really want to add <strong>{{
                                            displayUser.username }}</strong> as a moderator for <strong>{{
                                                    promotedType }}</strong>? <span class="text-danger">*</span></p>
                                    </div>
                                    <div v-if="chooseMod == 'remove' && doubleConfirmMod && !(successAddMod || errorAddMod || successRemoveMod || errorRemoveMod)"
                                        class="modal-body">
                                        <p class="text-start mb-1"> Do you really want to remove <strong>{{
                                            displayUser.username }}</strong> as a moderator for <strong>{{
                                                    removedType }}</strong>? <span class="text-danger">*</span></p>
                                    </div>

                                    <!-- Initial confirm mod to promote to promote footer -->
                                    <div v-if="(chooseMod == 'add' || chooseMod == 'remove') && !doubleConfirmMod && !(successAddMod || errorAddMod || successRemoveMod || errorRemoveMod)"
                                        class="modal-footer">
                                        <button type="button" @click="selectMode"
                                            class="btn btn-secondary">Return</button>
                                        <button v-if="chooseMod == 'add'" type="button" @click="doubleConfirm"
                                            class="btn btn-primary">Add Moderator</button>
                                        <button v-if="chooseMod == 'remove'" type="button" @click="doubleConfirm"
                                            class="btn btn-primary">Remove Moderator</button>
                                    </div>

                                    <!-- Double confirm mod to promote footer -->
                                    <div v-if="(chooseMod == 'add' || chooseMod == 'remove') && doubleConfirmMod && !(successAddMod || errorAddMod || successRemoveMod || errorRemoveMod)"
                                        class="modal-footer">
                                        <button v-if="chooseMod == 'add'" type="button" @click="addModMode"
                                            class="btn btn-secondary">Return</button>
                                        <button v-if="chooseMod == 'remove'" type="button" @click="removeModMode"
                                            class="btn btn-secondary">Return</button>
                                        <button type="button" @click="confirmModifyModerator"
                                            class="btn btn-primary">Confirm Moderator</button>
                                    </div>

                                    <!-- successaddmod and erroraddmod footer -->
                                    <div v-if="successAddMod || errorAddMod || successRemoveMod || errorRemoveMod"
                                        class="modal-footer">
                                        <button type="button" @click="selectMode"
                                            class="btn btn-secondary">Return</button>
                                        <button type="button" @click="selectMode" class="btn btn-secondary"
                        ...
                        <div v-if="user" class="modal fade" id="editProfileModal" tabindex="-1"
                                ...
                                <div class="modal-content">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <img :src="selectedImage || (user.photo || defaultProfilePhoto)"
                                                        alt=""
                                                        class="rounded-circle-no-bg border border-dark profile-img"
                                                        id="output" style="height:auto; width:100%; ">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-4 text-start ps-5" style="margin: auto;">
                                        ...
                                        <div class="edit-drink-choice">
                                            <div class="row">
                                                ...
                                                <div class="col-8 text-start">
                                                    ...
                                                    <div v-for="(type, index) in drinkType" :key="index" class="m-1"
                                                        style="display: inline-block">
                                                        <input type="checkbox" class="btn-check" :id="index"
                                                            autocomplete="off" v-model="selectedDrinks" :value="type">
                                                        <label v-if="selectedDrinks.includes(type)"
                                                            class="btn primary-btn-less-round" :for="index"
                                                            style="color: whitesmoke; background-color: #535C72; border: 4px solid #535C72;">{{
                                                                type }}</label>
                                                        <label v-else class="btn primary-btn-outline-less-round"
                                                            :for="index">{{ type }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row pt-5">
                                                ...
                                                <div class="col-8 text-start">
                                                    <div v-for="(tag, index) in flavourTags" :key="tag.familyTag + index"
                                                        class="m-1" style="display: inline-block">
                                                        <input type="checkbox" class="btn-check"
                                                            :id="'flavour-' + index" autocomplete="off"
                                                            v-model="selectedFlavours" :value="tag.familyTag">
                                                        <label
                                                            v-if="selectedFlavours.includes(tag.familyTag)"
                                                            class="btn primary-btn-less-round" :for="'flavour-' + index"
                                                            style="color: whitesmoke; background-color: #535C72; border: 4px solid #535C72;">
                                                            {{ tag.familyTag }}
                                                        </label>
                                                        <label v-else :for="'flavour-' + index"
                                                            class="btn primary-btn-outline-less-round">
                                                            {{ tag.familyTag }}
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="row pt-5">
                                                ...
                                                <div class="col-8 text-start">
                                                    <div v-for="(tag, index) in observationTags" :key="'tag-' + index"
                                                        class="m-1" style="display: inline-block">
                                                        <input type="checkbox" class="btn-check" :id="'tag-' + index"
                                                            autocomplete="off" v-model="selectedObservationTags"
                                                            :value="tag.observationTag">
                                                        <label
                                                            v-if="selectedObservationTags.includes(tag.observationTag)"
                                                            class="btn primary-btn-less-round" :for="'tag-' + index"
                                                            style="color: whitesmoke; background-color: #535C72; border: 4px solid #535C72;">
                                                            {{ tag.observationTag }}
                                                        </label>
                                                        <label v-else :for="'tag-' + index"
                                                            class="btn primary-btn-outline-less-round">
                                                            {{ tag.observationTag }}
                                                        </label>
                                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                            @click="cancelChanges">Close</button>
                                        <button type="button" class="btn btn-primary" @click="saveChangesDetails"
                        ...
                        <div v-if="user" class="modal fade" id="applyModerator" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body  px-5"> <!--text-center-->
                                        <div class="row">
                                            ...
                                            <div style="max-width:110px;">
                                                <svg v-if="photo == ''" xmlns="http://www.w3.org/2000/svg"
                                                    style="height:auto; width:100%; "
                                                    class="rounded-circle-no-bg border border-dark profile-img">
                                                ...
                                                <img v-else :src="photo" style="height:auto; width:100%;"
                                                    class="rounded-circle-no-bg border border-dark profile-img">
                                            </div>
                                            <div style="max-width:170px;" class="px-0">
                                                <button class="btn btn-warning hover-button p-1"
                                                    style="border-radius: 20px; font-size: 0.8rem;">★ Certified
                                                    Moderator</button>
                                            </div>
                                        </div>
                                        ...
                                        <p class="fs-5"><b>Help shape the drinks community and share your expertise as a
                                                moderator! Just some quick questions:</b></p>
                                        <!--- <a href="#" class="m-2" style="font-style: italic; color: inherit">Click here to learn more about being a moderator</a>-->

                                        <div class="px-3">
                                            <h6 class="m-3 mx-0">What drinks category would you like to moderate for?
                                            </h6>
                                            <select class="form-select w-50 mx-auto" style="border: 2px solid #535C72;"
                                                aria-label="Default select example" v-model="modCat">
                                                <option v-for="(type, index) in filteredDrinkType" :key="index"
                                                    :value="type">{{ type }}</option>
                                            </select>
                                            <h6 class="m-3 mx-0">Why do you want to be a Drink X moderator? What's your
                                                experience with this drink category?</h6>
                                            <div class="mb-3">
                                                <textarea class="form-control Xw-50 mx-auto"
                                                    style="border: 2px solid #535C72;" id="exampleFormControlTextarea1"
                                                    rows="3" v-model="modDesc"></textarea>
                                            </div>
                                        </div>
                                        <btn class="btn secondary-btn-border " data-bs-dismiss="modal"
                                            @click="submitModeratorApplication"
                                            style="margin-right: 40%;margin-left:40%;"><b>Apply Now!</b></btn>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-if="user" class="modal fade" id="changePasswordModal" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color: #535C72">
                                    ...
                                    <div class="modal-body text-center">
                                        <div
                                            ...
                                            <p class="text-start mb-1"> Old Password: <span class="text-danger">*</span>
                                            </p>
                                            <input type='password' v-model="oldPassword" class="form-control"
                                                id="oldPassword" placeholder="Enter Previous Password">
                                            <p class="text-start mt-3 mb-1"> New Password: <span
                                                    class="text-danger">*</span></p>
                                        ...
                                        <div
                                            ...
                                            <p v-show="isButtonDisabled" class="text-start mb-1 text-success"
                                                id="sendPinSuccess"></p>
                                            <p v-show="isButtonDisabled" class="text-start mb-1 text-danger"
                                                id="sendPinError"></p>
                                            <p v-show="verifyErrorMessage.length > 0"
                                        ...
                                        <div
                                            ...
                                            <b>Are you sure you want to reset your password? A new password will be sent
                                                to you.</b>
                                        </div>
                                        <div
                                        ...
                                        <p v-if="passwordSuccess" class="text-success fst-italic fw-bold fs-3">Password
                                            {{ changingPassword }} is successful!</p>
                                        <p v-if="passwordSuccess && confirmResetPassword"
                                            class="text-success fst-italic fw-bold fs-3">An email has been sent to you
                                            containing the password.</p>

                                        <!-- if password change/reset faces error -->
                                        <p v-if="passwordError" class="text-danger fst-italic fw-bold fs-3">There is an
                                            error during password {{ changingPassword }}, please try again!</p>
                                        <p v-if="passwordMismatch" class="text-danger fst-italic fw-bold fs-3">Old
                                            password do not match, please try again</p>
                                    </div>

                                    <div class="modal-footer">
                                        <!-- To return to previous select change password or reset password -->
                                        <button v-if="changingPassword != '' && !resettingPassword && !passwordSuccess"
                                            type="button" @click="selectPasswordMode"
                                            class="btn btn-secondary">Return</button>
                                        ...
                                        <button
                                            v-if="confirmResetPassword && !(passwordError || passwordSuccess || resettingPassword)"
                                            type="button" @click="resetPassword" class="btn btn-primary">Reset
                                            Password</button>
                        ...
                        <div class="mt-3">
                            ...
                            <div v-else class="container text-center mb-3">
                                ...
                                <div class="row">
                                    <div class="mobile-col-3 col-12 col-sm-4 col-md-6 col-xl-4 p-2 mobile-pt-0 mobile-pb-0 mobile-pe-2 mobile-mb-2 "
                                        v-for="drinkTypeDetails in matchedDrinkTypes" :key="drinkTypeDetails.id">
                                        ...
                                        <img :src="(drinkTypeDetails.badgePhoto || defaultProfilePhoto)" alt=""
                                            class="rounded-circle-white-bg border border-dark badge-img">
                                        <!-- badge description -->
                                        <div class="pt-1" style="line-height: 1;">
                                            <small>
                                                <b> {{ drinkTypeDetails.drinkType }} {{
                                                    categoryBadges[drinkTypeDetails.drinkType] }} </b>
                                            </small>
                                            <br>
                                            <small class="xs-text"
                                                v-for="(subcategory, category) of topSubcategoriesReviewed"
                                                :key="category">
                                                <span v-if="category === drinkTypeDetails.drinkType">
                                                    <i>
                                                        (Power: <span v-for="item in subcategory" :key="item">
                                                            {{ item }}<span
                                                                v-if="subcategory.indexOf(item) !== subcategory.length - 1">,
                                                            </span>
                                                        </span>)
                                                    </i>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="mobile-col-3 col-12 col-sm-4 col-md-6 col-xl-4 p-2 mobile-pt-0 mobile-pb-0 mobile-pe-2 mobile-mb-2"
                                        v-for="badge in otherBadges" :key="badge">
                                        <!-- image of actual badge style="width: 100px; height: 100px;" -->
                                        <!-- <img :src="'data:image/png;base64,'+ (getBadgeInfo(badge).badgePhoto)" 
                                            alt="" class="rounded-circle-white-bg border border-dark badge-img"> -->
                                        <img :src="(getBadgeInfo(badge)?.badgePhoto)" alt=""
                                            class="rounded-circle-white-bg border border-dark badge-img">
                                        <!-- badge description -->
                ...
                <div class="col-12 col-md-8">
                    <div style="
                        ...
                        margin-bottom: 16px;
                        ">
                                <img src="/Rectangle126.png" style="
                            width: 100%;
                            height: 100%;
                            object-fit: cover;
                        " />
                        ...
                        "></div>
                            ...
                            <h2
                                style="font-size: 24px; font-weight: normal; border-bottom: 1px solid #e0e0e0; padding-bottom: 16px;">
                                Welcome to Drink-X. Let's get started!
                            </h2>

                            <div>
                                <div style="display: flex; align-items: flex-start; gap: 16px; margin-bottom: 16px;">
                                    <img src="/Layer3.png" style="
                            width: 64px;
                            height: 64px;
                            object-fit: contain;
                            border-radius: 4px;
                            " alt="Review your first drink" />
                                ...
                                border-radius: 4px;
                                cursor: pointer;
                            " @mouseover="hoverButton($event)" @mouseleave="leaveButton($event)">
                                                Find A Drink
                                            </button>
                                        </router-link>
                                    </div>
                                ...
                                <div style="display: flex; align-items: flex-start; gap: 16px; margin-bottom: 16px;">
                                    <img src="/address-book.png" style="
                            width: 64px;
                            height: 64px;
                            object-fit: contain;
                            border-radius: 4px;
                            ...
                            " alt="Curate a list to share" />
                                ...
                                border-radius: 4px;
                                cursor: pointer;
                            " @mouseover="hoverButton($event)" @mouseleave="leaveButton($event)" data-bs-toggle="modal"
                    ...
                    <div class="mt-4">
                        ...
                        <!-- reviews button -->
                        <button class="btn mx-1 fw-bold no-hover"
                        ...
                        <div class="tab-content container mt-2 mobile-px-0">
                            ...
                            <div v-if="activeTab == 'reviews'" id="reviews">
                                ...
                                <ListingRowDisplayUserProfile :listingArr="favouriteListings"
                                    displayName="Favourite Listings" :user="user" :listing="listing" columnWidth="165px"
                                    @icon-clicked="handleIconClick" />

                                <ListingRowDisplayUserProfile :listingArr="recentActivity" displayName="Recent Activity"
                                    :user="user" :listing="listing" columnWidth="165px"
                                    @icon-clicked="handleIconClick" />
                            ...
                            <div v-if="activeTab == 'lists'" id="lists">
                                <button v-if="ownProfile" type="button"
                                    class="btn fw-bold primary-btn-less-round-blue xprimary-btn-outline-less-round mb-3"
                                    data-bs-toggle="modal" data-bs-target="#createNewListModal">Create New List</button>

                                <!-- display all lists -->
                                <div v-for="(bookmarkList, name, index) in displayUserBookmarks" :key="name"
                                    style="display: flex" class="row mb-3">
                                    <div class="col-3 mobile-col-4 mobile-pe-0">
                                        ...
                                        <img :src="(getListingFromID(bookmarkList.listItems[0])?.photo || defaultDrinkImage)"
                                            alt="" class="bottle-img me-3">
                                    </div>
                                    <div class="col-9 mobile-col-8 mobile-ps-1">
                                        <!-- style="height: 150px; display: flex; flex-direction: column;" -->
                                        <h5 class="mt-1" @click="viewList(name)" style="cursor: pointer"> {{ name }}
                                        </h5>
                                        <span v-if="bookmarkList.listItems.length > 1"> {{ bookmarkList.listItems.length
                                        }} items in list </span>
                                        ...
                                        <div style="display: flex; margin-top: auto;" class="mb-1">
                                            <b><a class="me-4 mobile-view-hide" @click="viewList(name)" href="#">View
                                                    List</a></b>
                                            <b><a class="me-4 mobile-view-show" @click="viewList(name)"
                                                    href="#">View</a></b>
                                            <b><a v-if="ownProfile && !(name == 'Drinks I Have Tried' || name == 'Drinks I Want To Try')"
                                                    class="mobile-view-hide me-2" href="#" data-bs-toggle="modal"
                                                    :data-bs-target="`#editListModal${index}`"
                                                    @click="resetEditList(name, bookmarkList.listDesc)">Edit
                                                    List</a></b>
                                            <b><a v-if="ownProfile && !(name == 'Drinks I Have Tried' || name == 'Drinks I Want To Try')"
                                                    class="mobile-view-hide " href="#" data-bs-toggle="modal"
                                                    :data-bs-target="`#deleteListModal${index}`">Delete List</a></b>
                                            <b><a v-if="ownProfile && !(name == 'Drinks I Have Tried' || name == 'Drinks I Want To Try')"
                                                    class="mobile-view-show me-2" href="#" data-bs-toggle="modal"
                                                    :data-bs-target="`#editListModal${index}`"
                                                    @click="resetEditList(name, bookmarkList.listDesc)">Edit</a></b>
                                            <b><a v-if="ownProfile && !(name == 'Drinks I Have Tried' || name == 'Drinks I Want To Try')"
                                                    class="mobile-view-show" href="#" data-bs-toggle="modal"
                                                    :data-bs-target="`#deleteListModal${index}`">Delete</a></b>

                                        </div>
                                    </div>

                                    <!-- edit list modal start -->
                                    <div class="modal fade" :id="`editListModal${index}`" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input v-model="editListName" type="text"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="basic-url" class="form-label">List
                                                            Description</label>
                                                        <div class="input-group mb-3">
                                                            <textarea v-model="editListDesc" type="text"
                                                                class="form-control"
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        @click="editList(name)">Save changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" :id="`deleteListModal${index}`" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="text-center">
                                                    <img src="../../../Images/Others/cancel.png" alt=""
                                                ...
                                                <div style="display: inline" class="text-center mb-4">
                                                    ...
                                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                                                        @click="deleteList(name)">Delete</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal fade" id="createNewListModal" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input v-model="newListName" type="text" class="form-control"
                                                        placeholder="List Name" aria-label="Username"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <textarea v-model="newListDesc" type="text" class="form-control"
                                                        placeholder="List Description (Optional)" aria-label="Username"
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" @click="addNewList">Save
                                                changes</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div v-if="activeTab == 'list' && displayUser.drinkLists" id="list">
                                ...
                                <div class="row mb-4 mobile-mt-4">
                                    ...
                                    <div class="col-7 mobile-col-5 text-end d-flex justify-content-end">
                                        <button v-if="ownProfile" type="button"
                                            class="btn primary-btn-outline-less-round drinklist" data-bs-toggle="modal"
                                        ...
                                        <button @click="updateCurrentURL" type="button"
                                            class="btn primary-btn-outline-less-round ms-3 drinklist"
                                            data-bs-toggle="modal" data-bs-target="#shareListModal">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                                class="bi bi-share mb-1 me-1 funnel-svg-dimensions" viewBox="0 0 30 30">
                                        ...
                                        <button @click="viewList('lists')" type="button"
                                            class="btn primary-btn-outline-less-round ms-3 drinklist">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        ...
                                        <div class="modal fade" id="shareListModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="shareMenuModalLabel"> Drink
                                                            List QR Code </h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                        <div class="modal-content">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            aria-describedby="button-addon2" v-model="drinkSearch"
                                                            @keyup="searchResult">
                                                    </div>
                                                    <!-- search results -->
                                                    <div class="overflow-auto"
                                                        :style="{ height: drinksToAdd.length > 0 ? '200px' : '300px' }">
                                                        <div class="form-check"
                                                            v-for="(drinkName, index) in drinkSearchResults"
                                                            :key="index">
                                                            <input class="form-check-input" type="checkbox"
                                                                :value="drinkName" :id="'drinkCheckbox' + index"
                                                                v-model="drinksToAdd">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-primary"
                                                    @click="addDrinkToList(currentList)">Add to List</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- list details -->
                                <div class="row mb-3"
                                    v-for="(listingID, index) in displayUser.drinkLists[currentList].listItems"
                                    :key="index">
                                    <div class="col-10 pe-0" style="display: flex">
                                        ...
                                        <img :src="(getListingFromID(listingID)?.photo || defaultDrinkImage)" alt=""
                                            style="width:130px; height:130px;" class="bottle-img me-3">
                                        <div style="min-height: 150px; display: flex; flex-direction: column;">
                                            <a :href="'/listing/view/' + listingID"
                                                style="text-decoration: none; color: inherit;">
                                                <h4>{{ getListingFromID(listingID)?.listingName }}</h4>
                                            </a>
                                            <p
                                                style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;">
                                                {{ getListingFromID(listingID)?.officialDesc }} </p>
                                            <div v-if="ownProfile" style="display: flex; margin-top: auto" class="mb-0">
                                                <a href="#" style="text-decoration: none; color: #535C72;"
                                                    data-bs-toggle="modal"
                                                    :data-bs-target="`#deleteFromListModal${index}`">
                                                    <!-- cross icon -->
                                                    <svg class=mb-1 xmlns="http://www.w3.org/2000/svg" height="16"
                                    ...
                                    <div class="col-2 text-center ps-0">
                                        <h2>
                                            ...
                                            <svg class="mb-2" xmlns="http://www.w3.org/2000/svg" height="18"
                                    ...
                                    <div class="modal fade" :id="`deleteFromListModal${index}`" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="text-end mt-2 me-2">
                                                ...
                                                <div class="text-center mx-2">
                                                    ...
                                                    <h3>Are you sure?</h3>
                                                    <br>
                                                    <p>Do you really want to delete <b><i>{{
                                                        getListingFromID(listingID)?.listingName }}</i></b> from
                                                        <b><i>{{ currentList }}</i></b>?
                                                    </p>
                                                </div>
                                                <div style="display: inline" class="text-center mb-4">
                                                    <button type="button" class="btn btn-secondary me-3"
                                                        data-bs-dismiss="modal">Cancel</button>
                                                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                                                        @click="deleteFromList(currentList, listingID)">Delete</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                const response = await this.$axios.post(`${process.env.VUE_APP_API_URL}/editProfile/editDetails`,
                    {
                        ...
                        flavourTags: this.selectedFlavours,
