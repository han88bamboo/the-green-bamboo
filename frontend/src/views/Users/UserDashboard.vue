                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-start pe-0">
                                ...
                                <img :src="selectedImage || (user['photo'] || defaultProfilePhoto)" alt=""
                                    style="width: 100px; height: auto; z-index: 1;"
                        ...
                        <div class="row mobile-view-show ps-2 pe-2 mt-3">
                            <button v-if="showFollowerActivity" type="button"
                                class="active-toggle-producer-QnA tertiary-text pt-2 pb-2 " data-bs-toggle="collapse"
                                data-bs-target="#collapseFollowerActivity" aria-expanded="false"
                                aria-controls="collapseFollowerActivity" style="font-weight:bold;"
                            ...
                            <button v-else type="button"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#collapseFollowerActivity"
                                aria-expanded="false" aria-controls="collapseFollowerActivity" style="font-weight:bold;"
                                @click="checkToShowFollowerActivity()">Follower Activity ↓</button>
                            <div class="collapse pt-3 pe-0 ps-0" id="collapseFollowerActivity">
                                <div class="square primary-square-green rounded p-3 mb-3 text-start">
                                    ...
                                    <div class="square-inline pb-2">
                                        <h4 class="square-inline text-start mr-auto"> Recent Activity from Your
                                            Followers </h4>
                                    </div>
                                    <!-- body -->
                                    <div style="height: 85%;">
                                        <div class="overflow-auto" style="max-height: 100%;">
                                            <!-- v-for loop here-->
                                            <div v-for="activity in recentFollowerActivity" v-bind:key="activity.id"
                                                class="py-2">
                                                <div v-if="activity.type === 'tag'">
                                                    <i>
                                                        <router-link :to="{ path: '/profile/user/' + activity.userID }"
                                                            class="reverse-clickable-text">
                                                            @<b> {{ getUserFromID(activity.userID).username }} </b>
                                                        </router-link>
                                                        tagged you in a review on
                                                        <router-link
                                                            :to="{ path: '/listing/view/' + activity.listingID }"
                                                            class="reverse-clickable-text">
                                                            <u> {{ getListingFromID(activity.listingID).listingName }}
                                                            </u>
                                                        </router-link>
                        ...
                        <div class="row pt-3 mobile-view-hide">
                            <div class="square primary-square-green rounded p-3 mb-3 text-start">
                                <!-- header text -->
                                <div class="square-inline pb-2">
                                    <h4 class="square-inline text-start mr-auto"> Recent Activity from Your Followers
                                    </h4>
                                </div>
                                <!-- body -->
                                <div style="height: 85%;">
                                        ...
                                        <div v-for="activity in recentFollowerActivity" v-bind:key="activity.id"
                                            ...
                                            <div v-if="activity.type === 'tag'">
                                                <i>
                                                    ...
                                                    tagged you in a review on
                                                    <router-link :to="{ path: '/listing/view/' + activity.listingID }"
                                                        class="reverse-clickable-text">
                        ...
                        <div class="row pt-3 mobile-view-show ps-2 pe-2">
                            <button v-if="showRecentActivity" type="button"
                                class="active-toggle-producer-QnA tertiary-text pt-2 pb-2 " data-bs-toggle="collapse"
                                data-bs-target="#collapseUserActivity" aria-expanded="false"
                                aria-controls="collapseUserActivity" style="font-weight:bold;"
                                @click="checkToShowRecentActivity()">Your Recent Activity ↑</button>
                            <button v-else type="button"
                                class="primary-btn-less-round-green tertiary-text pt-2 pb-2 border"
                                data-bs-toggle="collapse" data-bs-target="#collapseUserActivity" aria-expanded="false"
                                aria-controls="collapseUserActivity" style="font-weight:bold;"
                                @click="checkToShowRecentActivity()">Your Recent Activity ↓</button>
                            <div class="mt-3 collapse square primary-square-green rounded p-3 mb-3 text-start"
                                style="height: 325px;" id="collapseUserActivity">
                                <div class="square-inline pb-2">
                                ...
                                <div style="height: 85%;">
                                    <div class="overflow-auto" style="max-height: 100%;">
                                        <div v-for="activity in recentUserActivity" v-bind:key="activity.date"
                                            class="py-2">
                                            <div v-if="activity.type == 'review'">
                                                <i>
                                                    ...
                                                    <b>
                                                        ...
                                                        &nbsp;<span style="color: #F0B358">{{ activity.rating }}
                                                            stars</span>
                                                    </b>
                                                    {{ getTimeDifference(activity.date) }}
                                                </i>
                                            ...
                                            <div v-else>
                                                <i>
                                                    ...
                                                    <b>
                                                        <router-link
                                                            :to="{ path: `/profile/user/${userID}/${activity.listName}` }"
                                                            class="reverse-clickable-text">
                                                            <u><span style="color: #F0B358;">{{ activity.listName
                                                            }}</span></u>
                                                        </router-link>
                                                    </b>
                        ...
                        <div class="row pt-3 mobile-view-show ps-2 pe-2">
                            <button v-if="showReviewActivity" type="button"
                                class="active-toggle-producer-QnA tertiary-text pt-2 pb-2 " data-bs-toggle="collapse"
                                data-bs-target="#collapseReviewActivity" aria-expanded="false"
                                aria-controls="collapseReviewActivity" style="font-weight:bold;"
                                @click="checkToShowReviewActivity()">Activity On Your Reviews ↑</button>
                            <button v-else type="button"
                                class="primary-btn-less-round-green tertiary-text pt-2 pb-2 border"
                                data-bs-toggle="collapse" data-bs-target="#collapseReviewActivity" aria-expanded="false"
                                aria-controls="collapseReviewActivity" style="font-weight:bold;"
                                @click="checkToShowReviewActivity()">Activity On Your Reviews ↓</button>

                            <div class="mt-3 collapse square primary-square-green rounded p-3 mb-3 text-start"
                                style="height: 325px;" id="collapseReviewActivity">
                                <div class="square-inline pb-2">
                                ...
                                <div style="height: 85%;">
                                    <div class="overflow-auto" style="max-height: 100%;">
                                        <!-- v-for loop here-->
                                        <div v-for="activity in recentReviewActivity" v-bind:key="activity.id"
                                            class="py-2">
                                            <div v-if="activity.type === 'upvote' || activity.type === 'downvote'">
                                                <svg v-if="activity.type == 'upvote'" fill="#ffffff" height="16"
                                                ...
                                                <svg v-if="activity.type == 'downvote'" fill="#ffffff" height="16"
                                                    viewBox="0 0 24 24" width="16" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="m20.901 10.566c-.167-.345-.516-.566-.901-.566h-2-2v-3-4c0-.553-.447-1-1-1h-6c-.553 0-1 .447-1 1v5 2h-1-3c-.385 0-.734.221-.901.566-.166.347-.12.758.12 1.059l8 10c.19.237.477.375.781.375s.591-.138.781-.375l8-10c.24-.301.286-.712.12-1.059z" />
                                                </svg>
                                                <i>
                                                    Someone <span
                                                        :style="{ color: activity.type === 'upvote' ? '#90ee90' : '#ff7f7f' }">{{
                                                            activity.type }}d</span> your review on
                                                    <router-link
                                                        :to="{ path: '/listing/view/' + activity.reviewTarget }"
                                                        class="reverse-clickable-text">
                                                        <u> {{ getListingFromID(activity.reviewTarget).listingName }}
                                                        </u>
                                                    </router-link>
                                                    {{ getTimeDifference(activity.date) }}
                                                </i>
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 ps-lg-5">
                    ...
                    <ul class="nav nav-pills mobile-view-show pt-2" role="tablist">
                        ...
                        <li class="nav-item pe-2 pt-2 " role="presentation">
                            <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#countofreviews"
                                type="button" role="tab" aria-controls="countofreviews" aria-selected="true">Count of
                                Reviews</button>
                        </li>
                        <li class="nav-item pe-2 pt-2 " role="presentation">
                            <button class="nav-link " data-bs-toggle="pill" data-bs-target="#spreadofratings"
                                type="button" role="tab" aria-controls="spreadofratings" aria-selected="false">Spread of
                                Ratings</button>
                        </li>
                    </ul>
                    ...
                    <div class="row mobile-view-show tab-content">
                        ...
                        <div id="countofreviews"
                            class="tab-pane fade show active col-lg-5 col-md-12 col-sm-12 text-start pt-5 mobile-pt-3 mx-lg-3 ps-lg-0 pe-lg-0"
                            style="color:black;">
                            <Line :data="reviewsData" :options="chartOptions"></Line>
                        </div>

                        <!-- col 2: profile visits -->
                        <div id="spreadofratings"
                            class="tab-pane fade col-lg-5 col-md-12 col-sm-12 text-start pt-5 mobile-pt-3 mx-lg-3 ps-lg-0 pe-lg-0"
                            style="color:black;">
                    ...
                    <ul class="nav nav-pills mobile-view-show pt-2" role="tablist">
                        <hr>
                        <li class="nav-item pe-2 pt-2 " role="presentation">
                            <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#BestRatedExpressions"
                                type="button" role="tab" aria-controls="BestRatedExpressions" aria-selected="true">Best
                                Rated Drinks</button>
                        </li>
                        <li class="nav-item pe-2 pt-2 " role="presentation">
                            <button class="nav-link " data-bs-toggle="pill" data-bs-target="#BestRatedCategories"
                                type="button" role="tab" aria-controls="BestRatedCategories" aria-selected="false">Best
                                Rated Categories</button>
                        </li>
                    </ul>
                    <div style="min-height:450px;" class="row mobile-view-show tab-content">
                        <!-- col 1: your best rated drinks -->
                        <div id="BestRatedExpressions"
                            class="tab-pane fade show active col-lg-5 col-md-12 col-sm-12 text-start pt-5 mx-3 ps-lg-0 pe-lg-0 mobile-mx-0">
                        ...
                        <div id="BestRatedCategories"
                            class="tab-pane fade  col-lg-5 col-md-12 col-sm-12 text-start pt-5 mx-3 ps-lg-0 pe-lg-0 mobile-mx-0">
                            <!-- padding classes added by tzh-->

                            <div class="text-start pb-2" v-for="(category, index) in bestRatedCategories"
                                v-bind:key="category">
                                <div class="row ms-0 default-clickable-text ">
                                    <div
                                        class="col-2 d-flex align-items-center justify-content-center rounded-circle me-3">
                    ...
                    <div class="row mobile-view-hide">
                        ...
                        <!-- col 2: your best rated categories -->
                        <div class="col-lg-5 col-md-12 col-sm-12 text-start pt-5 mx-3 ps-lg-0 pe-lg-0"
                            style="color:black;"> <!-- padding classes added by tzh-->
...
export default {
    ...
    data() {
        return {
            ...
            selectedIndex: -1,
            selectedDrinks: [], // editted
            selectedDrinkDetails: [], //editted
