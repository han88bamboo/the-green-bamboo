              ...
              ">
                ...
                <div v-if="contentMode == 'menu'" id="menu">
                        <VenueMenuTabOriginal 
                            :venue-data="targetVenue"
                            :menu-data="searchMenuResults" 
                            :edit-mode="editMenuMode"
                            :self-view="selfView"
                            :loaded-listings-count="loadedListings.length"
                            ...
                            @claim-venue="claimVenueAccount"
                            @enable-edit-mode="enableEditMenuMode"
                            @cancel-edit="editMenuMode = false"
                            @update-menu="updateMenu"
                            @add-menu-section="addMenuSection"
                            @delete-menu-section="deleteMenuSection"
                            @populate-rename-modal="populateRenameMenuSectionModal"
                            @rename-menu-section="renameMenuSection"
                            @delete-menu-item="deleteMenuItem"
                            @add-additional-item="addAdditionalItem"
                            @remove-menu-item="removeMenuItem"
                            @reset-multiple-menu-items="resetMultipleMenuItems"
                            @debounced-search-producers="debouncedSearchProducers"
                            @select-producer="selectProducer"
                            @debounced-search-multiple="debouncedSearchMultiple"
                            @select-listing-multiple="selectListingMultiple"
                            @update-global-target-section="updateGlobalMenuItemTargetSection"
                            @add-multiple-menu-items="addMultipleMenuItems"
