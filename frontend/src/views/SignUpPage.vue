...
<template>
    ...
    >
        <span
            >An error occurred while loading this page, please try again!</span
        >
        <br />
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p
                                        ...
                                        style="font-style: italic"
                                    >
                                        Discover new juice and log your tasting
                                        notes!
                                    </p>
                                </div>
                                ...
                                <!-- Start of form -->
                                <form
                                    v-on:submit.prevent="submitListing"
                                    id="frm"
                                >
                                    <!-- Input: Username -->
                                    <div class="row pt-4">
                                    ...
                                    <div class="row pt-2">
                                        ...
                                        >
                                            <div class="form-floating">
                                                <div class="row">
                                                    <div
                                                        class="form-group pb-md-0 pb-2 col-md-6 col-12"
                                                    >
                                                        <div
                                                            class="form-floating"
                                                        >
                                    ...
                                    <div class="text-center mt-3 col mx-3">
                                        ...
                                        >
                                            <label class="form-check-label"
                                                >I verify I am above legal
                                                drinking age in my country of
                                                location</label
                                            >
                                            <input
                                ...
                                <div class="col mx-3">
                                    <b>
                                        <i>
                                            <p class="mb-2">
                                                If you are a drinks brand,
                                                bottler or venue owner trying to
                                                create an account,
                                                <router-link
                                                    :to="{
                                                        path: '/businessSignup',
    ...
    methods: {
        async loadData() {
            ...
            try {
                ...
                // Set flavourTags dynamically based on the API response
                this.observationTags = response.data.map(
                    (item) => item.observationTag
                );
        ...
        signUp() {
            ...
            let hashedPassword = this.hashPassword(
                this.username,
                this.password
            );
