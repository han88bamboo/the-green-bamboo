    ...
    async loginUser() {
      ...
      try {
        ...
        if (response.data.username == this.username) {
          ...
          localStorage.setItem("88B_username", response.data["username"]);

          console.log("Stored ID:", localStorage.getItem("88B_accID"));
          console.log("Stored username:", localStorage.getItem("88B_username"));
