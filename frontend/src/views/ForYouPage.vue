    ...
    <div v-if="search == false && dataLoaded == true">
        ...
        <div class="container pt-5 mobile-view-hide">
            <div class="row">
                <!-- tagline -->
                <div class="col-8">
                    <h1 class="text-start" v-if="userID == ''"> What We Think You Like! </h1>
                    <h1 class="text-start" v-else-if="userType == 'user'"> Hello, {{ displayName }}! What We Think You
                        Like!
                    </h1>
                    <h1 class="text-start" v-else> Hello, {{ username }}! What We Think You Like! </h1>
                </div>
                <!-- button -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-4 mb-3 mobile-view-no-padding">
                                <div class="d-grid gap-2 mx-1">
                                    <button class="btn btn-sm mobile-ps-0 text-center"
                                        ...
                                        <p class="mb-0_5 mt-0_5 discover-and-following mobile-mb-0"> Clubs </p>
                                    </button>
                                </div>
                            </div>
        ...
        async loadData() {
            ...
            try {
                const response = await this.$axios.get(
                    `${process.env.VUE_APP_API_URL}/getData/getRecommendedClubs/${this.userID}`,
                    {
                        headers: {
                ...
                this.recommendedClubs = response.data;
                console.log(this.recommendedClubs);
            } catch (error) {
                console.error(error);
