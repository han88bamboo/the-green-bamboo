        ...
        <div class="container pt-5 mobile-view-hide">
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <h1 class="text-start" v-else-if="userType == 'user'"> Hello, {{ displayName }}! What's Pouring?
                    </h1>
                        ...
                        <div class="row">
                            ...
                            <div v-if="discovery == true || following == false" class="mobile-ps-0 mobile-pe-0">
                                ...
                                <div class="container text-start mobile-ps-0 mobile-pe-0">
                                    ...
                                    <div v-for="listing in (selectedDrinkType == '' ? listings : filteredListings)"
                                        v-bind:key="listing.id" class="p-3 mobile-pt-0">
                                            ...
                                            <div class="col-7 mobile-p-0">
                                                ...
                                                <div class="row pt-1">
                                                    <router-link :to="{ path: '/listing/view/' + listing.id }"
                                                        ...
                                                        <h4 class="mobile-mb-0 mobile-view-hide"> <b> {{
                                                            listing["listingName"] }} </b> </h4>
                                                        <!-- tzh added mobile-mb-0-->
                                                        <h6 class="mobile-mb-0 mobile-view-show"> <b> {{
                                                            listing["listingName"] }} </b> </h6>
                                                        <!-- tzh added mobile-mb-0-->
                                                    </router-link>
                                                ...
                                                <div class="row mobile-view-hide"> <!-- tzh added mobile-view-hide -->
                                                    <router-link
                                                        ...
                                                        <h5 class="mobile-rating-smaller-text"> <b> {{
                                                            getProducerName(listing) }} </b> </h5>
                                                    </router-link>
                                                </div>
                            ...
                            <div v-else-if="following || discovery == false" class="mobile-ps-0 mobile-pe-0">
                                ...
                                <div class="container text-start">
                                    <h5 v-if="latestReviews.length == 0" style="display: inline-block;"> There is no
                                        listing available for the selected filter </h5>
                                    <div v-else v-for="review in latestReviews" v-bind:key="review.id"
                                        ...
                                        <div class="row gap-3">
                                            ...
                                            <div class="row my-auto">
                                                ...
                                                <div class="col-2 d-flex justify-content-center">
                                                    <img :src="(review['userInfo']['photo'] || defaultProfilePhoto)"
                                                ...
                                                <div class="col-10 d-flex align-items-center gap-2">
                                                    <router-link :to="{ path: '/profile/user/' + review.userID }"
                                                        class="primary-clickable-text">
                                                        <h5> <b> @{{ review['userInfo']['displayName'] }} </b> </h5>
                                                    </router-link>
                                                    <h5>just drank and rated </h5>
                                                    <router-link
                                                        :to="{ path: '/listing/view/' + review.reviewTarget.id }"
                                                        class="primary-clickable-text">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 col-12">
                                                    <div class="image-container mb-3 homepage">
                                                        <img v-if="review['reviewTarget']['photo']"
                                                            :src="review['photo']" class="img-border homepage">
                                                        <img v-else src="../../Images/Drinks/Placeholder.png"
                                                            class="img-border homepage">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="d-grid gap-5">
                                                                <router-link
                                                                    :to="{ path: '/listing/view/' + review.reviewTarget.id }"
                                                                    class="primary-clickable-text">
                                                                    <a class="btn secondary-btn btn-lg"
                                                                        style="font-weight: bold;"> View Drink Listing
                                                                    </a>
                                                                </router-link>
                                                            </div>
                                                        </div>
                                ...
                                <!-- v-loop for each listing -->
                                <div class="container text-start">
                                    <h5 v-if="recentlyAdded == ''" style="display: inline-block;"> There is no listing
                                        available for the selected filter </h5>
                                    <h5 v-if="recentlyAdded == '' || (selectedDrinkType != '' && filteredRecentlyAdded == '')"
                                        style="display: inline-block;"> There is no listing available for the selected
                                        filter </h5>
                                    <!-- <div v-for="listing in recentlyAdded" v-bind:key="listing.id" class="p-3 mobile-pt-0"> -->
                                    <div v-for="listing in (selectedDrinkType == '' ? recentlyAdded : filteredRecentlyAdded)"
                                        v-bind:key="listing.id" class="p-3 mobile-pt-0">
                                        <!-- For latest reviews -->
                                                ...
                                                <div class="row pt-4 mobile-pt-0"> <!--tzh added mobile-pt-0 -->
                                                    ...
                                                    <div class="col-6 mobile-view-hide">
                                                        ...
                                                        <div class="d-grid gap-5">
                                                            <router-link :to="{ path: '/listing/view/' + listing.id }"
                                                                class="primary-clickable-text">
                                                                <a class="btn secondary-btn btn-md"> Read what the crowd
                                                                    thinks </a>
                                                            </router-link>
                                                        </div>
                                                    </div>
