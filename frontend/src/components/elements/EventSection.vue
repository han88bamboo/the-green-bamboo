      ...
      <div v-if="selfView" class="d-flex flex-row justify-content-between align-items-center">
        ...
        <svg
          ...
          :style="{
            ...
            pointerEvents: disableCreateButton ? 'none' : 'auto'
          }"
        >
          <path
            fill-rule="evenodd"
            d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 
               0 0 1 0 1h-5v5a.5.5 0 0 1-1 
               0v-5h-5a.5.5 0 0 1 0-1h5v-5
               A.5.5 0 0 1 8 2"
          />
        </svg>
      </div>
        ...
        <div v-else class="col-12">
          ...
          >
            ...
            <div
              ...
              @click="$router.push({
                name: 'eventview',
                params: { eventID: event.id, eventName: event.eventName }
              })"
            >
              <img
                v-if="event.eventBanners"
                :src="event.eventBanners[0]"
                class="rounded img-fluid event-banner"
                alt="Event Banner"
              />
              <img
                v-else
            ...
            <div class="row">
              <p
                class="m-0 mt-2 hover-underline mobile-rating-smaller-text-2"
            ...
            <div class="row mt-0 pt-0">
              <p class="fw-normal small-text mobile-rating-smaller-text-2 text-success">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body text-start">
              <CreateEventPage @new-event="updateNewEvent" :userID="userID" :userType="userType" />
            </div>
    ...
    methods: {
        async initializeComponent() {
            ...
            try {
                ...
                const promises = [this.getEvents()];

                if (userType) {
                    this.userType = userType;

                    // Get create event status
                    promises.push(this.getCreateEventStatus());
                }
                else {
                ...
                console.error("Error initializing EventSection:", error);
            } finally {
