...
<template>
  <div class="navbar-container">
    ...
    <nav class="navbar pb-0">
      <div
        class="container-fluid align-items-center col-xxl-11 col-xl-11 col-lg-11 col-md-12 col-sm-12"
      >
        <!-- logo -->
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.getItem("88B_accID") != null) {
      ...
      let accUsername = localStorage.getItem("88B_username");

      let url = `${process.env.VUE_APP_API_URL}/getData/get`;

      if (this.accType == "user") {
        url = url + "User/" + accID + "/" + accUsername;
        this.loadData(url);
