<template>
  ...
  <section class="mb-4" style="padding-left: 0.75rem">
    <div class="row justify-content-start align-items-start">
      <div v-for="(imageData, index) in bottleReviewImages" :key="`bottle-${index}`"
        class="col-2 col-sm-2 col-md-2 col-lg-2 px-1 d-md-block d-none" @click="openDetailedReviewModal(imageData)">
        <div class="position-relative" style="cursor: pointer">
          <img :src="imageData.photo || defaultPhoto" :alt="`Review ${index + 1}`" class="review-image img-fluid"
            loading="lazy" />
      ...
      <div v-for="(imageData, index) in bottleReviewImages" :key="`bottle-mobile-${index}`" class="col-3 px-1 d-md-none"
  ...
  <section v-if="hasBottleReviews">
    <article v-for="review in bottleReviews" :key="review.id" class="mb-4">
      <div class="row">
        <!-- Review Content -->
        <div class="col-12 col-lg-9">
              ...
              <div class="col-2 col-lg-1">
                <router-link :to="`/profile/user/${review.userID}`">
                  <img :src="getPhotoFromReview(review) || defaultProfilePhoto"
                    :alt="`${getUsernameFromReview(review)} profile`" class="profile-image img-fluid rounded-circle" />
                </router-link>
              </div>
              ...
              <div class="col-10 ps-2 ps-lg-3">
                <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center">
                  <div class="me-lg-3 mb-1 mb-lg-0">
                    <router-link :to="`/profile/user/${review.userID}`" class="text-decoration-none text-dark fw-bold">
                  ...
                  <div class="d-flex align-items-center flex-wrap gap-2">
                    ...
                    <span class="badge small" :style="{ backgroundColor: getUserRankColor(review) }">
                ...
                <div class="mt-2">
                  ...
                  <router-link :to="getBottleRoute(review)" class="text-decoration-none text-dark fw-bold ms-1">
          ...
          <div class="mb-3">
            ...
            <button type="button" class="btn btn-link p-0 text-secondary text-decoration-underline"
        ...
        <div class="col-3 d-none d-lg-block text-end">
          <img :src="review.photo || defaultPhoto" :alt="`${getBottleNameFromReview(review)} review`"
            class="review-image img-fluid" style="width: 125px; height: 125px; object-fit: cover; cursor: pointer"
      ...
      <div class="row d-lg-none mt-3">
        <div class="col-12">
          <img :src="review.photo || defaultPhoto" :alt="`${getBottleNameFromReview(review)} review`"
            class="review-image img-fluid" style="max-width: 200px; cursor: pointer" data-bs-toggle="modal"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div v-if="successDelete" class="modal-body text-center py-4">
          ...
          <button type="button" class="btn btn-success" data-bs-dismiss="modal" @click="reloadRoute">
            Close
          </button>
        </div>
        ...
        <div v-else>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger" @click="deleteReview" :disabled="deletingReview">
