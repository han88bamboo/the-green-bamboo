...
INSERT INTO "users" ("username","displayName","choiceDrinks","modType","photo","hashedPassword","joinDate","firstName","lastName","email","isAdmin","birthday","pin", "choiceFlavours", "preferences", "grails", "upAndComing", "goats") VALUES
...
INSERT INTO "listings" (
    "listingName", "producerID", "bottler", "originCountry", "drinkType", "abv", "officialDesc", "allowMod", "addedDate", "typeCategory", "age", "reviewLink", "sourceLink", "photo", "drinkStyle", "googleFlavourTags")
	VALUES 
    ('Hennessy VS', 1, 'OB', 'Japan', 'Whiskey / Whisky', 12, 'BEST EVEERRRR', true, '2024-10-05 00:14:37.661786', 'Spirit', 12, '', '', '', '', '{Liquorice}'),
    ('Jack Daniel''s Old No. 7', 2, 'Jack Daniel''s', 'United States', 'Whiskey / Whisky', 40, 'The classic Tennessee whiskey with a smooth, charcoal-mellowed flavor.', true, '2024-02-02', 'Bourbon', NULL, '', '', '', '', '{Sweet Berries, Brown Sugar, Sweet Grain, Spicy Grain, Cinnamon, Fermented}'),
    ('Jack Daniel''s Single Barrel Select', 2, 'Jack Daniel''s', 'United States', 'Whiskey / Whisky', 47, 'A richer and more complex version of the classic Jack Daniel’s.', true, '2024-02-02', 'Bourbon', NULL, '', '', '', '', '{Sweet Berries, Sweet Wine, Candy, Vanilla Cream, Sweet Grain, Sweet Herbal, Cinnamon, Liquorice}'),
    ('Jack Daniel''s Tennessee Honey', 2, 'Jack Daniel''s', 'United States', 'Whiskey / Whisky', 35, 'A smooth blend of Jack Daniel’s and honey liqueur.', true, '2024-02-02', 'Flavored Whiskey', NULL, '', '', '', '', '{Sweet Berries, Sweet Grain, Cinnamon}'),
    ('Jack Daniel''s Sinatra Select', 2, 'Jack Daniel''s', 'United States', 'Whiskey / Whisky', 45, 'A premium whiskey honoring Frank Sinatra, aged in specially designed barrels.', true, '2024-02-02', 'Bourbon', NULL, '', '', '', '', '{}'),
    ('Jack Daniel''s Bonded', 2, 'Jack Daniel''s', 'United States', 'Whiskey / Whisky', 50, 'Bottled-in-bond whiskey with a bolder, richer flavor.', true, '2024-02-02', 'Bourbon', NULL, '', '', '', '', '{Vanilla Cream, Sweet Grain, Cinnamon, Roasted Chestnuts}'),
    ('Johnnie Walker Black Label', 3, 'Johnnie Walker', 'Scotland', 'Whiskey / Whisky', 40, 'A smooth, well-balanced blended Scotch aged 12 years.', true, '2024-02-02', 'Blended Scotch', 12, '', '', '', '', '{Sweet Berries, Green Fruits, Citrus, Stewed Fruits, Tart Fruits, Spicy Grain, Cinnamon, Oriental Spice, Mediterranean Spice, Fermented, Roasted Chestnuts}'),
    ('Johnnie Walker Blue Label', 3, 'Johnnie Walker', 'Scotland', 'Whiskey / Whisky', 43, 'An ultra-premium blend featuring rare, aged Scotch whiskies.', true, '2024-02-02', 'Blended Scotch', NULL, '', '', '', '', '{Sweet Berries, Sweet Grain, Spicy Grain, Sweet Herbal, Bitter Herbal, Cinnamon, Fermented, Roasted Chestnuts}'),
    ('Johnnie Walker Red Label', 3, 'Johnnie Walker', 'Scotland', 'Whiskey / Whisky', 40, 'A bold, fiery blend ideal for mixing in cocktails.', true, '2024-02-02', 'Blended Scotch', NULL, '', '', '', '', '{}'),
    ('Johnnie Walker Green Label', 3, 'Johnnie Walker', 'Scotland', 'Whiskey / Whisky', 43, 'A rich, green blend of malt whisky for a fresh taste.', true, '2024-02-02', 'Blended Scotch', NULL, '', '', '', '', '{Vanilla Cream, Sweet Grain, Roasted Chestnuts}'),
    ('Jameson Irish Whiskey', 4, 'Jameson', 'Ireland', 'Whiskey / Whisky', 40, 'A triple-distilled, smooth Irish whiskey with hints of vanilla and spice.', true, '2024-02-02', 'Irish Whiskey', NULL, '', '', '', '', '{Sweet Wine, Spicy Grain, Cinnamon, Liquorice, Oriental Spice}'),
    ('Jameson Black Barrel', 4, 'Jameson', 'Ireland', 'Whiskey / Whisky', 40, 'A rich, intense version of Jameson aged in charred barrels.', true, '2024-02-02', 'Irish Whiskey', NULL, '', '', '', '', '{Sweet Berries, Sweet Wine, Cinnamon, Liquorice}'),
    ('Jameson Caskmates Stout Edition', 4, 'Jameson', 'Ireland', 'Whiskey / Whisky', 40, 'Jameson finished in craft beer stout barrels for a deeper taste.', true, '2024-02-02', 'Irish Whiskey', NULL, '', '', '', '', '{}'),
    ('Jameson Crested', 4, 'Jameson', 'Ireland', 'Whiskey / Whisky', 40, 'A rich, smooth blend of Jameson whiskey with a creamy finish.', true, '2024-02-02', 'Irish Whiskey', NULL, '', '', '', '', '{Cinnamon}'),
    ('Chivas Regal 12', 5, 'Chivas Regal', 'Scotland', 'Whiskey / Whisky', 40, 'A smooth, honeyed Scotch whisky aged for 12 years.', true, '2024-02-02', 'Blended Scotch', 12, '', '', '', '', '{Sweet Berries, Sweet Wine, Vanilla Cream, Sweet Herbal, Bitter Herbal, Oriental Spice, Mediterranean Spice, Fermented}'),
    ('Chivas Regal 18', 5, 'Chivas Regal', 'Scotland', 'Whiskey / Whisky', 40, 'A more complex, rich Scotch aged 18 years.', true, '2024-02-02', 'Blended Scotch', 18, '', '', '', '', '{Sweet Berries, Sweet Herbal, Baking Spices, Cinnamon, Oriental Spice, Mediterranean Spice}'),
    ('Chivas Regal Extra', 5, 'Chivas Regal', 'Scotland', 'Whiskey / Whisky', 40, 'A rich, indulgent Scotch whisky with a warm, fruity flavor.', true, '2024-02-02', 'Blended Scotch', NULL, '', '', '', '', '{Sweet Wine, Sweet Herbal}'),
    ('Glenfiddich 12', 6, 'Glenfiddich', 'Scotland', 'Whiskey / Whisky', 40, 'A light and fruity single malt aged for 12 years.', true, '2024-02-02', 'Single Malt Scotch', 12, '', '', '', '', '{Sweet Berries, Sweet Wine}'),
    ('Glenfiddich 18', 6, 'Glenfiddich', 'Scotland', 'Whiskey / Whisky', 43, 'A richer, sherry-aged single malt aged 18 years.', true, '2024-02-02', 'Single Malt Scotch', 18, '', '', '', '', '{Liquorice}'),
    ('Glenfiddich 21', 6, 'Glenfiddich', 'Scotland', 'Whiskey / Whisky', 40, 'A rare single malt aged for 21 years with rich oak notes.', true, '2024-02-02', 'Single Malt Scotch', 21, '', '', '', '', '{Sweet Wine}'),
    ('Hennessy VS', 7, 'Hennessy', 'France', 'Cognac', 40, 'A smooth and bold cognac with notes of oak and fruit.', true, '2024-02-02', 'Cognac', NULL, '', '', '', '', '{Liquorice}'),
    ('Hennessy XO', 7, 'Hennessy', 'France', 'Cognac', 40, 'An extra-aged blend with a rich, complex flavor.', true, '2024-02-02', 'Cognac', NULL, '', '', '', '', '{Oriental Spice}'),
    ('Hennessy Paradis', 7, 'Hennessy', 'France', 'Cognac', 40, 'A luxurious, multi-layered cognac with deep, smooth flavors.', true, '2024-02-02', 'Cognac', NULL, '', '', '', '', '{Spicy Grain, Oriental Spice, Mediterranean Spice}'),
    ('Bacardi Superior', 8, 'Bacardi', 'Cuba', 'Rum / Rhum', 40, 'A light, smooth white rum perfect for cocktails.', true, '2024-02-02', 'White Rum', NULL, '', '', '', '', '{Sweet Berries, Sweet Wine, Sweet Herbal, Liquorice, Fermented}'),
    ('Bacardi Gold', 8, 'Bacardi', 'Cuba', 'Rum / Rhum', 40, 'A smooth, mellow gold rum with hints of vanilla.', true, '2024-02-02', 'Gold Rum', NULL, '', '', '', '', '{Sweet Berries, Sweet Wine, Sweet Herbal, Fermented}'),
    ('Captain Morgan Original Spiced Rum', 9, 'Captain Morgan', 'Jamaica', 'Rum / Rhum', 35, 'A smooth, spiced rum with hints of vanilla and cinnamon.', true, '2024-02-02', 'Spiced Rum', NULL, '', '', '', '', '{Cinnamon}'),
    ('Captain Morgan Private Stock', 9, 'Captain Morgan', 'Jamaica', 'Rum / Rhum', 40, 'A premium spiced rum with a bold, rich flavor.', true, '2024-02-02', 'Spiced Rum', NULL, '', '', '', '', '{}'),
    ('Don Julio Blanco', 10, 'Don Julio', 'Mexico', 'Tequila', 40, 'A fresh, crisp silver tequila with a smooth agave finish.', true, '2024-02-02', 'Tequila Blanco', NULL, '', '', '', '', '{Oriental Spice}'),
    ...
    ('Patrón Añejo', 10, 'Patrón', 'Mexico', 'Tequila', 40, 'Aged tequila with rich, oak and vanilla flavors.', true, '2024-02-02', 'Tequila Añejo', NULL, '', '', '', '', '{Bitter Herbal, Mediterranean Spice}'),
    ('Tanqueray London Dry Gin', 12, 'Tanqueray', 'United Kingdom', 'Gin', 47.3, 'A classic gin with a crisp, juniper-forward taste.', true, '2024-02-02', 'London Dry Gin', NULL, '', '', '', '', '{Bitter Herbal}'),
    ('Hendrick''s Gin', 13, 'Hendrick''s', 'Scotland', 'Gin', 44, 'A unique gin infused with cucumber and rose petals.', true, '2024-02-02', 'Gin', NULL, '', '', '', '', '{Fresh Herbs, Sweet Herbal, Bitter Herbal, Cinnamon}'),
    ('Bombay Sapphire Gin', 14, 'Bombay Sapphire', 'United Kingdom', 'Gin', 40, 'A smooth gin with a rich blend of 10 botanicals.', true, '2024-02-02', 'Gin', NULL, '', '', '', '', '{Citrus, Fresh Herbs, Juniper, Sweet Herbal, Bitter Herbal, Cinnamon, Oriental Spice}'),
    ('Suntory Hibiki', 15, 'Suntory', 'Japan', 'Whiskey / Whisky', 43, 'A harmonious blend of malt and grain whiskies aged in various casks.', true, '2024-02-02', 'Blended Whisky', NULL, '', '', '', '', '{Liquorice}'),
    ('Nikka From The Barrel', 16, 'Nikka', 'Japan', 'Whiskey / Whisky', 51.4, 'A bold, rich whisky with complex flavors of fruit and spice.', true, '2024-02-02', 'Blended Whisky', NULL, '', '', '', '', '{Bitter Herbal, Liquorice}'),
    ('Tito''s Handmade Vodka', 17, 'Tito''s', 'United States', 'Vodka', 40, 'A premium American vodka distilled from corn for a smooth finish.', true, '2024-02-02', 'Vodka', NULL, '', '', '', '', '{Liquorice}'),
    ('Grey Goose Vodka', 18, 'Grey Goose', 'France', 'Vodka', 40, 'A premium French vodka made from high-quality wheat.', true, '2024-02-02', 'Vodka', NULL, '', '', '', '', '{Liquorice}'),
    ('Absolut Vodka', 19, 'Absolut', 'Sweden', 'Vodka', 40, 'A famous Swedish vodka made with 100% natural ingredients.', true, '2024-02-02', 'Vodka', NULL, '', '', '', '', '{Liquorice}'),
    ('Tiger Beer', 20, 'Tiger Brewery', 'Singapore', 'Beer', 5, 'A crisp, refreshing lager brewed in Singapore.', true, '2024-02-02', 'Lager - All Styles', NULL, '', '', '', 'Pilsner', '{Fermented}'),
    ('Tiger Crystal', 20, 'Tiger Brewery', 'Singapore', 'Beer', 4.6, 'A smooth, lighter version of the classic Tiger Beer.', true, '2024-02-02', 'Lager - All Styles', NULL, '', '', '', 'Helles', '{Sweet Berries, Candy, Syrup, Brown Sugar, Cola Syrup, Burnt Sugar}'),
    ('Tiger Black', 20, 'Tiger Brewery', 'Singapore', 'Beer', 6.9, 'A full-bodied, stronger version of Tiger Beer.', true, '2024-02-02', 'Lager - All Styles', NULL, '', '', '', 'Vienna Lager', '{Sweet Berries, Candy, Brown Sugar, Milk Chocolate, Coffee, Cacao, Bitter Herbal}');
...
VALUES
    ...
    ('Green Fruits', 'Sweet Berries'),
    ('Citrus', 'Green Fruits'),
    ('Green Fruits', 'Melons'),
    ('Fruit Cake', 'Green Fruits'),
    ('Green Fruits', 'Tart Fruits'),
    ('Green Fruits', 'Pickled'),
    ('Green Fruits', 'Stewed Fruits'),
    ...
    ('Sweet Berries', 'Yellow Fruits'),
    ('Citrus', 'Yellow Fruits'),
    ('Melons', 'Yellow Fruits'),
    ('Fruit Cake', 'Yellow Fruits'),
    ('Tart Fruits', 'Yellow Fruits'),
    ('Pickled', 'Yellow Fruits'),
    ('Stewed Fruits', 'Yellow Fruits'),
    ('Dried Fruits', 'Orchard Fruits'),
    ('Dried Fruits', 'Stone Fruits'),
    ('Dried Fruits', 'Tinned Fruit'),
    ('Dried Fruits', 'Unripe Fruits'),
    ('Dried Fruits', 'Fruit Flowers'),
    ('Dried Fruits', 'Tropical Fruits'),
    ('Dried Fruits', 'Sweet Berries'),
    ('Citrus', 'Dried Fruits'),
    ('Dried Fruits', 'Melons'),
    ('Dried Fruits', 'Fruit Cake'),
    ('Dried Fruits', 'Tart Fruits'),
    ('Dried Fruits', 'Stewed Fruits'),
    ...
    ('Fruit Cake', 'Orchard Fruits'),
    ('Orchard Fruits', 'Tart Fruits'),
    ('Orchard Fruits', 'Pickled'),
    ('Orchard Fruits', 'Stewed Fruits'),
    ('Stone Fruits', 'Tinned Fruit'),
    ('Stone Fruits', 'Unripe Fruits'),
    ('Fruit Flowers', 'Stone Fruits'),
    ('Stone Fruits', 'Tropical Fruits'),
    ('Melons', 'Stone Fruits'),
    ('Fruit Cake', 'Stone Fruits'),
    ('Stone Fruits', 'Tart Fruits'),
    ('Pickled', 'Stone Fruits'),
    ('Tinned Fruit', 'Unripe Fruits'),
    ('Fruit Flowers', 'Tinned Fruit'),
    ('Tinned Fruit', 'Tropical Fruits'),
    ('Citrus', 'Tinned Fruit'),
    ('Melons', 'Tinned Fruit'),
    ('Fruit Cake', 'Tinned Fruit'),
    ('Tart Fruits', 'Tinned Fruit'),
    ('Stewed Fruits', 'Tinned Fruit'),
    ('Liquorice', 'Sweet Wine'),
    ('Fruit Flowers', 'Unripe Fruits'),
    ('Tropical Fruits', 'Unripe Fruits'),
    ('Fruit Cake', 'Unripe Fruits'),
    ('Tart Fruits', 'Unripe Fruits'),
    ('Pickled', 'Unripe Fruits'),
    ('Fruit Flowers', 'Tropical Fruits'),
    ('Fruit Flowers', 'Melons'),
    ('Fruit Cake', 'Fruit Flowers'),
    ('Fruit Flowers', 'Tart Fruits'),
    ('Fruit Flowers', 'Stewed Fruits'),
    ('Citrus', 'Tropical Fruits'),
    ('Melons', 'Tropical Fruits'),
    ('Fruit Cake', 'Tropical Fruits'),
    ('Tart Fruits', 'Tropical Fruits'),
    ('Stewed Fruits', 'Tropical Fruits'),
    ('Citrus', 'Melons'),
    ('Fruit Cake', 'Tart Fruits'),
