                ...
                <ul class="nav nav-pills mobile-view-show pt-2"  role="tablist" >
                   ...
                   <li class="nav-item pe-2 pt-2 " role="presentation">
                    ...
                    <div style="min-height:450px;" class="row mobile-view-show tab-content">
                        ...
                        <div id="BestRatedExpressions" class="tab-pane fade show active col-lg-5 col-md-12 col-sm-12 text-start pt-5 mx-3 ps-lg-0 pe-lg-0">
                        ...
                        <div id="BestRatedCategories" class="tab-pane fade  col-lg-5 col-md-12 col-sm-12 text-start pt-5 mx-3 ps-lg-0 pe-lg-0"> <!-- padding classes added by tzh-->
